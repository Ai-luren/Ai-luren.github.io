...
这是一个以章节浏览为主的个人作品集，不是传统的项目管理后台。页面把真实的创作路径拆成五个阶段：动态设计、产品品牌、特效玩法、AI 效果交付，以及持续探索中的 AI 工作流；工作经历区以倒叙 Tab 直接切换详情。
...
```text
.
├── assets/                 图片、视频和 README 展示素材（页面使用系统字体栈）
├── docs/                   设计规范与交接说明
