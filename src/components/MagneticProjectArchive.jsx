...
const ARCHIVES = [
  ...
  { id: '03', title: { zh: '通义万相先导片', en: 'Tongyi Wanxiang Teaser' }, category: { zh: 'AI 创意广告', en: 'Creative Ads' }, award: { zh: '通义官号首发', en: 'Featured by Tongyi Official' }, cover: tongyiCover, href: 'https://www.xiaohongshu.com/discovery/item/688c8fe10000000025029684?source=webshare&xhsshare=pc_web&xsec_token=AB-XBU6QEyozPm_ytwWd0BvdTlO-gqHMp_rmAlmaeRo-g=&xsec_source=pc_share' },
  ...
  { id: '05', title: { zh: '猫咪的一天', en: "A Cat's Day" }, category: { zh: 'AI 创意短片', en: 'Short Films' }, award: { zh: '中国联通三等奖', en: 'China Unicom 3rd Prize' }, cover: catsCover, href: 'https://www.xiaohongshu.com/discovery/item/6858bb32000000002400ba58?source=webshare&xhsshare=pc_web&xsec_token=AB264App4J-oDzd1MVj8VrczGn9Tlyk1Y0L3Ob2aYkFag=&xsec_source=pc_share' },
