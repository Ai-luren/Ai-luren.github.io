...
const awards = [
  ...
  { image: '获奖截图/画板 7.jpg', title: 'MJ 官方优秀作品', meta: 'Midjourney / Featured' },
...
function CircularAwardGallery() {
  ...
  return (
    <div className="impact-glass impact-award-shell">
      <div className="impact-evidence-note"><span>AWARD ARCHIVE / 08 PROOFS</span><span>DRAG TO TRACE</span></div>
  ...
  return (
    <div className="impact-glass impact-reach-dossier">
      <div className="impact-reach-dossier-head">
        <span>CONTENT REACH / PROFILE PROOFS</span>
        <span>FOUR CHANNELS / REAL EVIDENCE</span>
      </div>
  ...
  return (
    <div className="impact-evidence">
      <section className="impact-evidence-row" aria-labelledby="impact-awards-title">
        <ImpactLabel index="01 / INDUSTRY AWARDS" title="行业奖项" description="作品先被看见，再被行业记住。" />
      ...
      <section className="impact-evidence-row" aria-labelledby="impact-programs-title">
        <ImpactLabel index="02 / CREATOR PROGRAMS" title="创作者认证" description="持续进入不同平台的创作者生态。" />
      ...
      <section className="impact-evidence-row" aria-labelledby="impact-reach-title">
        <ImpactLabel index="03 / CONTENT REACH" title="内容影响力" description="作品离开页面，继续向外传播。" />
        <div><h3 id="impact-reach-title" className="sr-only">内容影响力</h3><ReachDossier /></div>
      </section>
    </div>
  );
}
